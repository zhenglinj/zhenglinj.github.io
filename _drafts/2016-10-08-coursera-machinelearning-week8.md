...
![](/images/ml-images/6709f5ca3cd2240d4e95dcc3d3e808d5.png)
...
![](/images/ml-images/ff180f091e9bad9ac185248721437526.png)
...
![](/images/ml-images/ff1db77ec2e83b592bbe1c4153586120.jpg)

迭代 1 次

![](/images/ml-images/acdb3ac44f1fe61ff3b5a77d5a4895a1.jpg)

迭代 3 次

![](/images/ml-images/fe6dd7acf1a1eddcd09da362ecdf976f.jpg)
...
![](/images/ml-images/fed50a4e482cf3aae38afeb368141a97.png)
...
![](/images/ml-images/8605f0826623078a156d30a7782dfc3c.png)
...
![](/images/ml-images/d4d2c3edbdd8915f4e9d254d2a47d9c7.png)
...
![](/images/ml-images/f3ddc6d751cab7aba7a6f8f44794e975.png)
...
![](/images/ml-images/2373072a74d97a9f606981ffaf1dd53b.png)
...
![](/images/ml-images/2c95b316a3c61cf076ef132d3d50b51c.png)
...
![](/images/ml-images/8274f0c29314742e9b4f15071ea7624a.png)

将数据从三维降至二维：
这个例子中我们要将一个三维的特征向量降至一个二维的特征向量。过程是与上面类似的，我们将三维向量投射到一个二维的平面上，强迫使得所有的数据都在同一个平面上，降至二维的特征向量。

![](/images/ml-images/67e2a9d760300d33ac5e12ad2bd5523c.jpg)
...
![](/images/ml-images/789d90327121d3391735087b9276db2a.png)

假使我们有有关于许多不同国家的数据，每一个特征向量都有50个特征（如**GDP**，人均**GDP**，平均寿命等）。如果要将这个50维的数据可视化是不可能的。使用降维的方法将其降至2维，我们便可以将其可视化了。

![](/images/ml-images/ec85b79482c868eddc06ba075465fbcf.png)
...
![](/images/ml-images/a93213474b35ce393320428996aeecd9.jpg)
...
![](/images/ml-images/7e1389918ab9358d1432d20ed20f8142.png)
...
![](/images/ml-images/0918b38594709705723ed34bb74928ba.png)
$$Sigma=\dfrac {1}{m}\sum^{n}_{i=1}\left( x^{(i)}\right) \left( x^{(i)}\right) ^{T}$$

![](/images/ml-images/01e1c4a2f29a626b5980a27fc7d6a693.png)
...
![](/images/ml-images/a4477d787f876ae4e72cb416a2cb0b8a.jpg)
...
![](/images/ml-images/0a4edcb9c0d0a3812a50b3e95ef3912a.png)
...
![](/images/ml-images/66544d8fa1c1639d80948006f7f4a8ff.png)
