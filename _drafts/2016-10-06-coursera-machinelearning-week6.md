---
typora-root-url: ../
title: "Coursera Andrew Ng 机器学习第6周 应用机器学习的建议"
...
![](/images/ml-images/f49730be98810b869951bbe38b6319ba.png)
...
![](/images/ml-images/9c769fd59c8a9c9f92200f538d1ab29c.png)
...
![](/images/ml-images/751e868bebf4c0bf139db173d25e8ec4.png)
...
![](/images/ml-images/1b908480ad78ee54ba7129945015f87f.jpg)

	显然越高次数的多项式模型越能够适应我们的训练数据集，但是适应训练数据集并不代表着能推广至一般情况，我们应该选择一个更能适应一般情况的模型。我们需要使用交叉验证集来帮助选择模型。

	即：使用60%的数据作为训练集，使用 20%的数据作为交叉验证集，使用20%的数据作为测试集

![](/images/ml-images/7cf1cd9c123a72ca4137ca515871689d.png)
...
![](/images/ml-images/20c6b0ba8375ca496b7557def6c00324.jpg)

	我们通常会通过将训练集和交叉验证集的代价函数误差与多项式的次数绘制在同一张图表上来帮助分析：

![](/images/ml-images/bca6906add60245bbc24d71e22f8b836.png)
...
![](/images/ml-images/64ad47693447761bd005243ae7db0cca.png)
...
![](/images/ml-images/25597f0f88208a7e74a3ca028e971852.png)
...
![](/images/ml-images/2ba317c326547f5b5313489a3f0d66ce.png)
...
![](/images/ml-images/8f557105250853e1602a78c99b2ef95b.png)
...
![](/images/ml-images/38eed7de718f44f6bb23727c5a88bf5d.png)
...
![](/images/ml-images/969281bc9b07e92a0052b17288fb2c52.png)

![](/images/ml-images/973216c7b01c910cfa1454da936391c6.png)

	如何利用学习曲线识别高偏差/欠拟合：作为例子，我们尝试用一条直线来适应下面的数据，可以看出，无论训练集有多么大误差都不会有太大改观：

![](/images/ml-images/4a5099b9f4b6aac5785cb0ad05289335.jpg)

	也就是说在高偏差/欠拟合的情况下，增加数据到训练集不一定能有帮助。

	如何利用学习曲线识别高方差/过拟合：假设我们使用一个非常高次的多项式模型，并且正则化非常小，可以看出，当交叉验证集误差远大于训练集误差时，往训练集增加更多数据可以提高模型的效果。

![](/images/ml-images/2977243994d8d28d5ff300680988ec34.jpg)
...
神经网络的方差和偏差：
![](/images/ml-images/c5cd6fa2eb9aea9c581b2d78f2f4ea57.png)
...
![](/images/ml-images/ad00c2043ab31f32deb2a1eb456b7246.png)
...
![](/images/ml-images/84067e23f2ab0423679379afc6ed6caf.png)
...
![](/images/ml-images/1a7c575dc1b606b8e6e4de71a14dc005.png)
...
![](/images/ml-images/befe860fd4b1aef2f6eebf617baf5877.jpg)
...
![](/images/ml-images/05a3c884505e08028d37a04472d0964a.png)
