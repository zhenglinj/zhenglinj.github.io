---
typora-root-url: ../
title: "Coursera Andrew Ng 机器学习第1周 引言"
...
这里有一些机器学习的案例。比如说，数据挖掘。机器学习被用于数据挖掘的原因之一是网络和自动化技术的增长，这意味着，我们有史上最大的数据集比如说，大量的硅谷公司正在收集**web**上的单击数据，也称为点击流数据，并尝试使用机器学习算法来分析数据，更好的了解用户，并为用户提供更好的服务。这在硅谷有巨大的市场。再比如，医疗记录。随着自动化的出现，我们现在有了电子医疗记录。如果我们可以把医疗记录变成医学知识，我们就可以更好地理解疾病。再如，计算生物学。还是因为自动化技术，生物学家们收集的大量基因数据序列、**DNA**序列和等等，机器运行算法让我们更好地了解人类基因组，大家都知道这对人类意味着什么。再比如，工程方面，在工程的所有领域，我们有越来越大、越来越大的数据集，我们试图使用学习算法，来理解这些数据。另外，在机械应用中，有些人不能直接操作。例如，我已经在无人直升机领域工作了许多年。我们不知道如何写一段程序让直升机自己飞。我们唯一能做的就是让计算机自己学习如何驾驶直升机。
...
![](/images/coursera-machinelearning/2d99281dfc992452c9d32e022ce71161.png)
...
![](/images/coursera-machinelearning/4f80108ebbb6707d39b7a6da4d2a7a4e.png)
...
![](/images/coursera-machinelearning/c34fa10153f223aa955d6717663a9f91.png)
...
![](/images/coursera-machinelearning/0c93b5efd5fd5601ed475d2c8a0e6dcd.png)

![](/images/coursera-machinelearning/94f0b1d26de3923fc4ae934ec05c66ab.png)
...
![](/images/coursera-machinelearning/903868fb76c706f1e2f96d8e26e0074e.png)
...
![](/images/coursera-machinelearning/743c1d46d4288f8884f0981d437a15c1.png)
...
![](/images/coursera-machinelearning/8e76e65ca7098b74a2e9bc8e9577adfc.png)
...
![](/images/coursera-machinelearning/44c68412e65e62686a96ad16f278571f.png)
...
![](/images/coursera-machinelearning/d385f8a293b254454746adee51a027d4.png)
...
![](/images/coursera-machinelearning/6168b654649a0537c67df6f2454dc9ba.png)
...
![](/images/coursera-machinelearning/27ee0db04705fb20fab4574bb03064ab.png)
...
![](/images/coursera-machinelearning/10ba90df2ada721cf1850ab668204dc9.png)

![](/images/coursera-machinelearning/2c9fe871ca411ba557e65ac15d55745d.png)
...
![](/images/coursera-machinelearning/0b789788fc15889fe33fb44818c40852.png)

代价函数的样子，等高线图，则可以看出在三维空间中存在一个使得$J(\theta_{0}, \theta_{1})$最小的点。

![](/images/coursera-machinelearning/86c827fe0978ebdd608505cd45feb774.png)
...
![](/images/coursera-machinelearning/db48c81304317847870d486ba5bb2015.jpg)

想象一下你正站立在山的这一点上，站立在你想象的公园这座红色山上，在梯度下降算法中，我们要做的就是旋转360度，看看我们的周围，并问自己要在某个方向上，用小碎步尽快下山。这些小碎步需要朝什么方向？如果我们站在山坡上的这一点，你看一下周围，你会发现最佳的下山方向，你再看看周围，然后再一次想想，我应该从什么方向迈着小碎步下山？然后你按照自己的判断又迈出一步，重复上面的步骤，从这个新的点，你环顾四周，并决定从什么方向将会最快下山，然后又迈进了一小步，并依此类推，直到你接近局部最低点的位置。

批量梯度下降（**batch gradient descent**）算法的公式为：

![](/images/coursera-machinelearning/7da5a5f635b1eb552618556f1b4aac1a.png)

其中$a$是学习率（**learning rate**），它决定了我们沿着能让代价函数下降程度最大的方向向下迈出的步子有多大，在批量梯度下降中，我们每一次都同时让所有的参数减去学习速率乘以代价函数的导数。

![](/images/coursera-machinelearning/ef4227864e3cabb9a3938386f857e938.png)
...
![](/images/coursera-machinelearning/13176da01bb25128c91aca5476c9d464.png)
...
![](/images/coursera-machinelearning/0c31b42f1ee2b0703decf4e6c55d61d1.wmf)
...
![](/images/coursera-machinelearning/4668349e04cf0c4489865e133d112e98.png)
...
![](/images/coursera-machinelearning/9fa04927c2bd15780f92a7fafb539179.png)
...
![](/images/coursera-machinelearning/ffddfddfdfd.png)

矩阵的乘法：每个元素都要乘

![](/images/coursera-machinelearning/fdddddd.png)
...
![](/images/coursera-machinelearning/437ae2333f00286141abe181a1b7c44a.png)

算法举例：

![](/images/coursera-machinelearning/b2069e4b3e12618f5405500d058118d7.png)
...
![](/images/coursera-machinelearning/1a9f98df1560724713f6580de27a0bde.jpg)
![](/images/coursera-machinelearning/5ec35206e8ae22668d4b4a3c3ea7b292.jpg)
