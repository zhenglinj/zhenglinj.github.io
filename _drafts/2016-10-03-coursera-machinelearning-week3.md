...
![](/images/ml-images/a77886a6eff0f20f9d909975bb69a7ab.png)

我们从二元的分类问题开始讨论。

我们将因变量(**dependent variable**)可能属于的两个类分别称为负向类（**negative class**）和正向类（**positive class**），则因变量$y\in { 0,1 \\}$ ，其中 0 表示负向类，1 表示正向类。

![](/images/ml-images/f86eacc2a74159c068e82ea267a752f7.png)

![](/images/ml-images/e7f9a746894c4c7dfd10cfcd9c84b5f9.png)
...
![](/images/ml-images/29c12ee079c079c6408ee032870b2683.jpg)
...
![](/images/ml-images/d027a0612664ea460247c8637b25e306.jpg)
...
![](/images/ml-images/1073efb17b0d053b4f9218d4393246cc.jpg)
...
![Want ：](/images/ml-images/171031235719.png)
...
所以，如果你有 $n$ 个特征，也就是说：![](/images/ml-images/0171031235044.png)，参数向量$\theta $包括${\theta_{0}}$ ${\theta_{1}}$ ${\theta_{2}}$ 一直到${\theta_{n}}$，那么你就需要用这个式子：
...
![](/images/ml-images/743a769317d584a66509fc394b4e6095.png)
...
![](/images/ml-images/bd074e119a52163691cff93c3f42a1ee.png)
...
![](/images/ml-images/71d723ddb5863c943fcd4e6951114ee3.png)
...
![](/images/ml-images/2726da11c772fc58f0c85e40aaed14bd.png)
