---
typora-root-url: ../
title: "Coursera Andrew Ng 机器学习第4周 神经网络"
...
![](/images/ml-images/5316b24cd40908fb5cb1db5a055e4de5.png)
...
![](/images/ml-images/3ac5e06e852ad3deef4cba782ebe425b.jpg)
...
![](/images/ml-images/7912ea75bc7982998870721cb1177226.jpg)
...
![](/images/ml-images/2b74c1eeff95db47f5ebd8aef1290f09.jpg)
...
![](/images/ml-images/95c020b2227ca4b9a9bcbd40099d1766.png)
...
![](/images/ml-images/697ae58b1370e81749f9feb333bdf842.png)

第三个例子是触觉皮带，如果你把它戴在腰上，蜂鸣器会响，而且总是朝向北时发出嗡嗡声。它可以使人拥有方向感，用类似于鸟类感知方向的方式。

还有一些离奇的例子：

![](/images/ml-images/1ee5c76a62b35384491c603bb54c8c0c.png)
...
![](/images/ml-images/3d93e8c1cd681c2b3599f05739e3f3cc.jpg)
...
![](/images/ml-images/7dabd366525c7c3124e844abce8c2dd6.png)

神经网络模型建立在很多神经元之上，每一个神经元又是一个个学习模型。这些神经元（也叫激活单元，**activation unit**）采纳一些特征作为输出，并且根据本身的模型提供一个输出。下图是一个以逻辑回归模型作为自身学习模型的神经元示例，在神经网络中，参数又可被成为权重（**weight**）。

![](/images/ml-images/c2233cd74605a9f8fe69fd59547d3853.jpg)

我们设计出了类似于神经元的神经网络，效果如下：

![](/images/ml-images/fbb4ffb48b64468c384647d45f7b86b5.png)
...
![](/images/ml-images/8293711e1d23414d0a03f6878f5a2d91.jpg)
...
![](/images/ml-images/20171101224053.png)
...
![](/images/ml-images/303ce7ad54d957fca9dbb6a992155111.png)

![](/images/ml-images/2e17f58ce9a79525089a1c2e0b4c0ccc.png)

我们令 ${{z}^{\left( 2 \right)}}={{\theta }^{\left( 1 \right)}}x$，则 ${{a}^{\left( 2 \right)}}=g({{z}^{\left( 2 \right)}})$ ，计算后添加 $a_{0}^{\left( 2 \right)}=1$。 计算输出的值为：

![](/images/ml-images/43f1cb8a2a7e9a18f928720adc1fac22.png)
...
![](/images/ml-images/6167ad04e696c400cb9e1b7dc1e58d8a.png)

右半部分其实就是以$a_0, a_1, a_2, a_3$, 按照**Logistic Regression**的方式输出$h_\theta(x)$：

![](/images/ml-images/10342b472803c339a9e3bc339188c5b8.png)
...
![](/images/ml-images/809187c1815e1ec67184699076de51f2.png)
...
![](/images/ml-images/6d652f125654d077480aadc578ae0164.png)



![](/images/ml-images/f75115da9090701516aa1ff0295436dd.png)
...
![](/images/ml-images/aa27671f7a3a16545a28f356a2fb98c0.png)
...
![](/images/ml-images/57480b04956f1dc54ecfc64d68a6b357.jpg)

下图的神经元（三个权重分别为-10，20，20）可以被视为作用等同于逻辑或（**OR**）：

![](/images/ml-images/7527e61b1612dcf84dadbcf7a26a22fb.jpg)

下图的神经元（两个权重分别为 10，-20）可以被视为作用等同于逻辑非（**NOT**）：

![](/images/ml-images/1fd3017dfa554642a5e1805d6d2b1fa6.jpg)
...
![](/images/ml-images/4c44e69a12b48efdff2fe92a0a698768.jpg)

然后将表示 **AND** 的神经元和表示$\left( \text{NOT}\, \text{x}_1 \right) \text{AND} \left( \text{NOT}\, \text{x}_2 \right)$的神经元以及表示 OR 的神经元进行组合：

![](/images/ml-images/432c906875baca78031bd337fe0c8682.jpg)
...
![](/images/ml-images/f3236b14640fa053e62c73177b3474ed.jpg)

![](/images/ml-images/685180bf1774f7edd2b0856a8aae3498.png)

神经网络算法的输出结果为四种可能情形之一：

![](/images/ml-images/5e1a39d165f272b7f145c68ef78a3e13.png)
