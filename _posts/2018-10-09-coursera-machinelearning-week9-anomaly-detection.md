---
typora-root-url: ../
title: "Coursera Machine Learning | 机器学习第9周 异常检测"
...
![](/images/coursera-machinelearning/93d6dfe7e5cb8a46923c178171889747.png)

这样一来，你就有了一个数据集，从$x^{(1)}$到$x^{(m)}$，如果你生产了$m$个引擎的话，你将这些数据绘制成图表，看起来就是这个样子：

![](/images/coursera-machinelearning/fe4472adbf6ddd9d9b51d698cc750b68.png)
...
![](/images/coursera-machinelearning/65afdea865d50cba12d4f7674d599de5.png)
...
![](/images/coursera-machinelearning/fcb35433507a56631dde2b4e543743ee.png)
...
![](/images/coursera-machinelearning/ba47767a11ba39a23898b9f1a5a57cc5.png)

下面的三维图表表示的是密度估计函数，$z$轴为根据两个特征的值所估计$p(x)$值：

![](/images/coursera-machinelearning/82b90f56570c05966da116c3afe6fc91.jpg)
...
![](/images/coursera-machinelearning/0990d6b7a5ab3c0036f42083fe2718c6.jpg)
...
![](/images/coursera-machinelearning/f406bc738e5e032be79e52b6facfa48e.png)
...
![](/images/coursera-machinelearning/598db991a7c930c9021cec5f6ab9beb9.png)
...
![](/images/coursera-machinelearning/29df906704d254f18e92a63173dd51e7.jpg)
...
![](/images/coursera-machinelearning/3dbee365617e9264831400e4de247adc.png)
...
![](/images/coursera-machinelearning/d1a228f2bec262f2206379ed844c7f4a.png)

首先，我们把我们的训练集，和我们的拟合模型，我们计算$p(x)$，要知道，设定$\mu$和描述的一样$\Sigma$。

![](/images/coursera-machinelearning/015cee3a224dde6da0181215cf91a23d.png)
...
![](/images/coursera-machinelearning/7104dd2548f1251e4c423e059d1d2594.png)

原始模型和多元高斯分布比较如图：

![](/images/coursera-machinelearning/f4585239738f2b5149608879fa166889.png)
...
![](/images/coursera-machinelearning/c2822f2c28b343d7e6ade5bd40f3a1fc.png)
...
![](/images/coursera-machinelearning/747c1fd6bff694c6034da1911aa3314b.png)
...
![](/images/coursera-machinelearning/42a92e07b32b593bb826f8f6bc4d9eb3.png)

推出评分：

![](/images/coursera-machinelearning/c905a6f02e201a4767d869b3791e8aeb.png)

找到相关影片：

![](/images/coursera-machinelearning/0a8b49da1ab852f2996a02afcaca2322.png)
...
![](/images/coursera-machinelearning/54b1f7c3131aed24f9834d62a6835642.png)

如果我们新增一个用户 **Eve**，并且 **Eve** 没有为任何电影评分，那么我们以什么为依据为**Eve**推荐电影呢？

我们首先需要对结果 $Y $矩阵进行均值归一化处理，将每一个用户对某一部电影的评分减去所有用户对该电影评分的平均值：

![](/images/coursera-machinelearning/9ec5cb55e14bd1462183e104f8e02b80.png)
